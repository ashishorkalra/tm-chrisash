...
```{r}
apa.data.frame <- as.data.frame(apa.data.object)
dpp.data.frame <- as.data.frame(dpp.data.object)
...
- quality of data from apa is not right, some time it is giving error for conversion to data frame (need to look into characters of data from apa) (ashish)
